...
encode.addEventListener('click', () => {
    result.innerHTML = converter(inputValue.value,2,16);
});
...
btnOctal.addEventListener('click', () => {
    resultOctal.innerHTML = converter(inputOctal.value,2,8);
});
...
btnDecimal.addEventListener('click', () => {
    resultDecimal.innerHTML = converter(inputDecimal.value,2,10);
});
