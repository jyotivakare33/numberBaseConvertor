...
encode.addEventListener('click', () => {
    result.innerHTML = converter(inputValue.value,16,10);
});
...
btnOctal.addEventListener('click', () => {
    resultOctal.innerHTML = converter(inputOctal.value,16,8);
});
...
btnDecimal.addEventListener('click', () => {
    resultDecimal.innerHTML = converter(inputDecimal.value,16,2);
});
